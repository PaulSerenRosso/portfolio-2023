...
<template>
  ...
  <three-responsive-transform :ratio-obj-tag="this.tag" :event-key-for-get-ratio-obj-tag="this.hasRatioObjCreatedEvent?this.tag+'OnCreated':''" :macro-container-resize-event-key="this.macroContainerResizeEventKey" :current-obj-tag="this.tag+'Root'" :three-transform-responsive-property-group="this.threeTransformResponsivePropertyGroup"  ></three-responsive-transform>
