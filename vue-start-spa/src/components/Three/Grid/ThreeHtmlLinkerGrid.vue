...
export default {
  name: "ThreeHtmlLinkerGrid",
  components: {RevealAnimationTrigger, ThreeJsHtmlPositionLinker},
  props:{
    baseId:String,
  ...
  created() {
    console.log("testa",this.threePropertyGroups)
    console.log(this.threePropertyGroups)
  },
