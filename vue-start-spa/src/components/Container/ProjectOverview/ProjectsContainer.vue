  ...
  data(){
    return{
        threeGridResponsivePropertyGroup:new ResponsivePropertyGroup(
            new ThreeGridProperty(new Vector3(1,1,1), new Vector3(0.5,0.56,0.5),10,new Vector2(0.2,0.35), new Vector3(0.5,0.12,1),new Vector2(0.1,0.1)),
            new ThreeGridProperty(new Vector3(1,1,1), new Vector3(0.5,0.56,0.5),10,new Vector2(0.2,0.35), new Vector3(0.5,0.12,1),new Vector2(0.1,0.1)),
            new ThreeGridProperty(new Vector3(1,1,1), new Vector3(0.4,0.6,0.5),10,new Vector2(0.3,0.25), new Vector3(0.2,0.2,1),new Vector2(0.1,0.1)),
            new ThreeGridProperty(new Vector3(1,1,1), new Vector3(0.4,0.6,0.5),10,new Vector2(0.3,0.25), new Vector3(0.2,0.2,1),new Vector2(0.1,0.1))
        ),
      threeGridTextResponsivePropertyGroupTemplate:new ResponsivePropertyGroup(
          new ThreeGridProperty(new Vector3(0.6,0.1,0), new Vector3(0,0.10,0),5,new Vector2(0.15,0.03), new Vector3(0.05,0.025,0.5),new Vector2(0.15,0.1)),
          new ThreeGridProperty(new Vector3(0.6,0.1,0), new Vector3(0,0.10,0),5,new Vector2(0.15,0.03), new Vector3(0.05,0.025,0.5),new Vector2(0.15,0.1)),
